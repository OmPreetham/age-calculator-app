...
This project is a solution to the Age Calculator App challenge on Frontend Mentor.io. It is a simple web application that calculates a person's age based on their date of birth.
...
1. Clone this repository to your local machine using the following command:
   ...
   ```
   git clone https://github.com/OmPreetham/age-calculator-app.git
   ```
